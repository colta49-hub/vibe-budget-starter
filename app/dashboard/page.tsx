  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Link href="/dashboard/reports" className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow flex items-center gap-4">
          <span className="text-3xl">📊</span>
          <div>
            <h3 className="font-semibold text-gray-900">Rapoarte</h3>
            <p className="text-sm text-gray-500">Grafice și analiză AI</p>
          </div>
        </Link>
      </div>
    </div>
